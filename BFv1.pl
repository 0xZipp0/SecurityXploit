...
sub banner() {
print color('bold red')," __   __  ";print color('bold white')," ____             _          ______                 \n";
print color('bold red')," \\ \\ / / ";print color('bold white')," |  _ \\           | |        |  ____|                \n"; 
print color('bold red'),"  \\ V /  "; print color('bold white')," | |_) |_ __ _   _| |_ ___   |  |__ __  _ __ ___ ___ _ __ \n";
print color('bold red'),"   > <   "; print color('bold white')," |  _ <| '__| | | |  _/ _ \\  |  __/ _ \\| '__/ __/ _ \\ '__|\n";
...
print color('bold red'),"]";
print color('bold red')," DruPal \n";
print color('bold red')," [";
print color('bold green'),"4";
print color('bold red'),"]";
print color('bold blue')," OpenCart \n";
print color('bold red')," [";
print color('bold green'),"5";
print color('bold red'),"]";
print color('bold cyan')," Magento \n";
print color('bold red')," [";
